...
public class SpriteLoader {
	...
	public static void loadSprites(StreamLoader archive) {
		try {
			Stream index = new Stream(DataUtils.readFile(sign.signlink.findcachedir() + "extras/sprites.idx"));
			Stream data = new Stream(DataUtils.readFile(sign.signlink.findcachedir() + "extras/sprites.dat"));
