...
public final class EntityDef {
	...
	public static EntityDef forID(int i) {
		...
		switch (i) {
		case 384:
			entityDef.name = "Barbarian Trainer";
			break;
		case 1282:
		case 546:
		case 683:
	...
	public static void unpackConfig(StreamLoader streamLoader) {
		stream = new Stream(StreamLoader.read(new File(signlink.findcachedir() + "npc474.dat")));
		Stream stream2 = new Stream(StreamLoader.read(new File(signlink.findcachedir() + "npc474.idx")));
