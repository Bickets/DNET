...
public final class Player extends Entity {
	...
	public Model getRotatedModel() {
		if (!visible)
			return null;
		if (this == Client.myPlayer && Client.myPlayerInvisible)
			return null;
		...
		if (super.anInt1520 != -1 && super.anInt1521 != -1) {
			...
			if (model_2 != null) {
				...
				model_3.createBones();
				model_3.applyAnimation(spotAnim.aAnimation_407.anIntArray353[super.anInt1521]);
	...
	public void updatePlayer(Stream stream) {
		...
		int oldHeadIcon = headIcon;
		headIcon = stream.readUnsignedByte();
		if (oldHeadIcon != headIcon)
		  freshlyActivatedHeadIcon = true;
		...
		if (model_1 == null) {
			...
			for (int j3 = 0; j3 < 5; j3++)
				if (anIntArray1700[j3] != 0) {
					model_1.setColor(Client.anIntArrayArray1003[j3][0],
							Client.anIntArrayArray1003[j3][anIntArray1700[j3]]);
					if (j3 == 1)
						model_1.setColor(Client.anIntArray1204[0], Client.anIntArray1204[anIntArray1700[j3]]);
				}

			model_1.createBones();
			model_1.setLighting(64, 850, -30, -50, -30, true);
	...
	public Model method453() {
		...
		for (int j1 = 0; j1 < 5; j1++)
			if (anIntArray1700[j1] != 0) {
				model.setColor(Client.anIntArrayArray1003[j1][0], Client.anIntArrayArray1003[j1][anIntArray1700[j1]]);
				if (j1 == 1)
					model.setColor(Client.anIntArray1204[0], Client.anIntArray1204[anIntArray1700[j1]]);
			}
	...
	int anInt1722;
	int skill;
	public boolean freshlyActivatedHeadIcon;
