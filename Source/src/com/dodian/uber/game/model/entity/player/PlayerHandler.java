...
public class PlayerHandler {
  ...
  public static ConcurrentHashMap<Long, Client> playersOnline = new ConcurrentHashMap<Long, Client>();
  public static ConcurrentHashMap<Long, Integer> allOnline = new ConcurrentHashMap<Long, Integer>();
  public static int cycle = 0;
  public static long lastChest = 0, lastChest2 = 0, LastGem = 0, lastbar = 0, lastherb = 0, lasthide = 0;
...
//	}
  ...
  public static boolean isPlayerOn(String playerName) {
    return allOnline.containsKey(playerName);
  }
