...
import com.dodian.uber.game.model.player.packets.outgoing.SendSideTab;
...
public class MagicOnItems implements Packet {
  ...
  public void ProcessPacket(Client client, int packetType, int packetSize) {
    ...
    if (!(System.currentTimeMillis() - client.lastAction > 1000) || !client.playerHasItem(castOnItem) || value < 1
    ...
    if (castSpell == 1162 || castSpell == 1178) // Low Alch
    {
      ...
      if (client.premiumItem(castOnItem) || (castOnItem >= 2415 && castOnItem <= 2417) || value < 1) {
      ...
      client.giveExperience(650, Skill.MAGIC);
