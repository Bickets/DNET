    ...
    if (id < definitions.length) {
      if (definitions[id] == null) {
        ...
        if (def == null)
          ...
          GameObjectData obj = new GameObjectData(id, def.name, description, def.xLength, def.yLength, def.isSolid,
              def.isWalkable, def.hasActions, def.boolean64, def.walkType);
          if (id == 2781)
            obj.sizeX = 3;
          definitions[id] = obj;
        }
